...
execute as @a[scores={SkyblockCE_id=10}] run scoreboard objectives remove 1.21.4_PVN_0b
execute as @a[scores={SkyblockCE_import=20}] run scoreboard objectives remove 1.21.4_PVN_0b
