...
execute as @a[scores={Voidblock_islands=4}] run tellraw @a {"translate":"Voidblock.loading.chat"}
...
execute in minecraft:overworld as @a[scores={Voidblock_very_small=1}] run title @a title {"translate":"Voidblock.loading.title.chat"}
execute in minecraft:overworld as @a[scores={Voidblock_very_small=1}] run title @a subtitle {"translate":"Voidblock.loading.subtitle.chat"}
