...
function Voidblock_legacy_pid:pid_remove
...
##The Nether
execute as @a[scores={PID_legacy_v1=100..500}] run scoreboard players set @a Voidblock_islands 5
...
execute in minecraft:overworld as @a[scores={PID_legacy_v2=860}] run scoreboard players set @a Voidblock_level_dat 50000
execute in minecraft:overworld as @a[scores={PID_legacy_v2=860}] run tellraw @a [{"translate":"Voidblock.warning_level.dat.issues","color":"red","italic":true},{"translate":"Voidblock.warning_level.dat.download","color":"red","italic":true,"underlined":true,"clickEvent":{"action":"open_url","value":"https://github.com/Loweredgames/Voidblock/raw/main/.worlds/.worlds-level.dat/Level.dat.zip"}},{"translate":"Voidblock.warning_level.dat.copy_paste","color":"red","italic":true},{"text":"/scoreboard objectives add fix_custom_world dummy","underlined":true,"clickEvent":{"action":"copy_to_clipboard","value":"/scoreboard objectives add fix_custom_world dummy"}},{"translate":"Voidblock.warning_level.dat.end","color":"red","italic":true}]
