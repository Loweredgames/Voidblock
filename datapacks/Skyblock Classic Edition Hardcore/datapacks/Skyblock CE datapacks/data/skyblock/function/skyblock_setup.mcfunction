...
execute as @a[scores={Voidblock_install=3}] run tellraw @a ["",{"translate":"Voidblock.Voidblock_setup.welcome","bold":true},{"text":":","bold":true},{"text":"\n\n"},{"translate":"Voidblock.install.hardcore.lock","italic":true,"color":"red"},{"translate":"Voidblock.generated_structures.generated.command_block.download","italic":true,"underlined":true,"color":"red","clickEvent":{"action":"open_url","value":"https://github.com/Loweredgames/Voidblock/releases"}},{"translate":"Voidblock.install.hardcore.lock.replace_datapack","italic":true,"color":"red"}]
...
execute as @a[scores={Voidblock_install=1}] run effect give @a saturation 11 255 true
execute as @a[scores={Voidblock_install=1}] run effect give @a blindness 61 0 false
