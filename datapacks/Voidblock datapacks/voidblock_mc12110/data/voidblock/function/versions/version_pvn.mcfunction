...
scoreboard objectives add PVN_0_mc1219c dummy
scoreboard players add @a PVN_0_mc1219c 1
execute as @a[scores={Voidblock_id=10}] run scoreboard objectives remove PVN_0_mc1219c
execute as @a[scores={Voidblock_import=20}] run scoreboard objectives remove PVN_0_mc1219c
