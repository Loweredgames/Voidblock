...
execute in minecraft:overworld as @a[scores={Voidblock_fools=1}] run gamerule commandBlockOutput false
execute in minecraft:overworld as @a[scores={Voidblock_fools=1}] run gamerule doImmediateRespawn true
...
execute in minecraft:overworld as @a[scores={Voidblock_fools=1}] run gamerule announceAdvancements false
