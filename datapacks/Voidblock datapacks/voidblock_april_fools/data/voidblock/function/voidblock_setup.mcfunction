...
function voidblock:islands/mcfools_islands
function voidblock:structures/generated_test_structures
...
execute as @a[scores={Voidblock_fools=2000000..}] run scoreboard players set @a Voidblock_fools 10000


##Islands Choices Setup
execute as @a[scores={Voidblock_install_fools=2}] run tellraw @a {"text":"\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n"}
execute as @a[scores={Voidblock_install_fools=3}] run tellraw @a ["",{"text":"Welcome to the Voidblock April Fools Edition","bold":true},{"text":" - "},{"text":"Version:","bold":true},{"text":" 7.3.0 - April Fools [Rebranding Update] - JE-26.1-7.3.0-Voidblock-Fools:BUILDING:02.04.2026a","italic":true},{"text":"\n\n"},{"text":"for","bold":true},{"text":" Minecraft Java Edition: ","bold":true},{"text":"26.1 Herdcraft Update","italic":true},{"text":"\n\n\u2b1c\u2b1c\u2b1c\u2b1c\u2b1c\u2b1c\u2b1c\u2b1c\u2b1c\u2b1c\u2b1c\u2b1c\u2b1c\u2b1c\u2b1c\u2b1c\u2b1c\u2b1c\u2b1c\u2b1c\u2b1c\u2b1c\u2b1c\u2b1c\u2b1c\u2b1c\n\n"},{"text":"Click Below to Continue:","italic":true},{"text":"\n\n"},{"text":"Herdcraft Update","color":"dark_green","click_event":{"action":"run_command","command":"scoreboard players set @a Voidblock_islands_fools 1"}},{"text":' ',"color":"dark_green"},{"text":"[?]","color":"dark_green","hover_event":{"action":"show_text","value":"Will you be able to finish the skyblock without using the inventory?"}},{"text":"\n\n\u2b1c\u2b1c\u2b1c\u2b1c\u2b1c\u2b1c\u2b1c\u2b1c\u2b1c\u2b1c\u2b1c\u2b1c\u2b1c\u2b1c\u2b1c\u2b1c\u2b1c\u2b1c\u2b1c\u2b1c\u2b1c\u2b1c\u2b1c\u2b1c\u2b1c\u2b1c\n\n"},{"text":"This version is incompatible and must be used with the correct April release of Minecraft.","italic":true},""]
...
execute in minecraft:overworld run tp @a[scores={Voidblock_tp_fools=2}] 67 60 -3 0 90
execute in minecraft:the_nether run tp @a[scores={Voidblock_tp_fools=3}] 0 50 0 0 90
execute in minecraft:the_nether run tp @a[scores={Voidblock_tp_fools=4}] 4 55 33 0 90
execute in minecraft:the_nether run tp @a[scores={Voidblock_tp_fools=5}] -2 50 -50 0 90
execute in minecraft:overworld run tp @a[scores={Voidblock_tp_fools=6}] 25 70 1022 0 90