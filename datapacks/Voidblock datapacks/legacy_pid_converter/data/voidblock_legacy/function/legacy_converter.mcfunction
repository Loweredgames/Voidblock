...
execute as @a[scores={skyblock_large=1400..}] run effect give @a minecraft:slow_falling 180 0 false
...
execute as @a[scores={skyblock_normal=1400..}] run effect give @a minecraft:slow_falling 180 0 false
...
execute as @a[scores={skyblock_small=1400..}] run effect give @a minecraft:slow_falling 180 0 false
