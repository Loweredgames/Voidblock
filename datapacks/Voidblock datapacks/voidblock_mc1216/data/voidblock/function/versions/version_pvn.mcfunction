...
scoreboard objectives add 1.21.5_PVN_0 dummy
scoreboard players add @a 1.21.5_PVN_0 1
execute as @a[scores={Voidblock_id=10}] run scoreboard objectives remove 1.21.5_PVN_0
execute as @a[scores={Voidblock_import=20}] run scoreboard objectives remove 1.21.5_PVN_0
