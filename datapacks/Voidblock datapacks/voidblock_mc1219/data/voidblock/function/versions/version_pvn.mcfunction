...
scoreboard objectives add 1.21.8_PVN_1 dummy
scoreboard players add @a 1.21.8_PVN_1 1
execute as @a[scores={Voidblock_id=10}] run scoreboard objectives remove 1.21.8_PVN_1
execute as @a[scores={Voidblock_import=20}] run scoreboard objectives remove 1.21.8_PVN_1
