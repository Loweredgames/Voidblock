...
execute as @a[scores={Voidblock_pid_1_mc1219=-100..}] run scoreboard players set @a Voidblock_pid_0_mc1219 1
execute as @a[scores={Voidblock_pid_1_mc1219=-100..}] run scoreboard players set @a Voidblock_pid_0_mc1219 1
execute as @a[scores={Voidblock_pid_1_mc1219=-100..}] run scoreboard players set @a Voidblock_pid_0_mc1219 1
...
execute as @a[scores={Voidblock_pid_0_mc1219=1..}] run scoreboard players add @a PID_old_v1 1
execute as @a[scores={Voidblock_pid_0_mc1219=1..}] run scoreboard players add @a PID_old_v2 1
execute as @a[scores={Voidblock_pid_0_mc1219=1..}] run scoreboard players add @a PID_old_v3 1
...
execute as @a[scores={PID_old_v1=805..}] run scoreboard objectives remove Voidblock_pid_0_mc1219
execute as @a[scores={PID_old_v2=990..}] run scoreboard objectives remove Voidblock_pid_0_mc1219
execute as @a[scores={PID_old_v3=990..}] run scoreboard objectives remove Voidblock_pid_0_mc1219
...
###FUNCTION PID OLD v1 - Voidblock_pid_0_mc1219 - 1.21.9 (NON RIMUOVERE IL COMMENTO IN SE)
...
execute as @a[scores={PID_old_v1=745}] run scoreboard objectives add Voidblock_pid_0_mc1219 dummy
execute as @a[scores={PID_old_v1=750}] run scoreboard objectives add PID_old dummy


###FUNCTION PID OLD v2 - Voidblock_pid_0_mc1219 - 1.21.9 (NON RIMUOVERE IL COMMENTO IN SE)
...
execute as @a[scores={PID_old_v2=745}] run scoreboard objectives add Voidblock_pid_0_mc1219 dummy
execute as @a[scores={PID_old_v2=750}] run scoreboard objectives add PID_old dummy


###FUNCTION PID OLD v3 - Voidblock_pid_0_mc1219 - 1.21.9 (NON RIMUOVERE IL COMMENTO IN SE)
...
execute as @a[scores={Voidblock_pid_0_mc1219=1..}] run scoreboard players set @a Voidblock_pid_1_mc1219 -100
execute as @a[scores={Voidblock_pid_0_mc1219=1..}] run scoreboard players set @a Voidblock_pid_1_mc1219 -100
execute as @a[scores={Voidblock_pid_0_mc1219=1..}] run scoreboard players set @a Voidblock_pid_1_mc1219 -100
