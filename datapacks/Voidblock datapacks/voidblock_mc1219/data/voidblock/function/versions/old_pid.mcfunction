...
execute as @a[scores={PID_1_mc1219=-100..}] run scoreboard players set @a PID_0_mc1219 1
execute as @a[scores={PID_1_mc1219=-100..}] run scoreboard players set @a PID_0_mc1219 1
execute as @a[scores={PID_1_mc1219=-100..}] run scoreboard players set @a PID_0_mc1219 1
...
execute as @a[scores={PID_1_mc1219=1000..}] run scoreboard objectives remove PID_old_v1
execute as @a[scores={PID_1_mc1219=1000..}] run scoreboard objectives remove PID_old_v2
execute as @a[scores={PID_1_mc1219=1000..}] run scoreboard objectives remove PID_old_v3
...
execute as @a[scores={PID_0_mc1219=1..}] run scoreboard players set @a PID_1_mc1219 -100
execute as @a[scores={PID_0_mc1219=1..}] run scoreboard players set @a PID_1_mc1219 -100
execute as @a[scores={PID_0_mc1219=1..}] run scoreboard players set @a PID_1_mc1219 -100
