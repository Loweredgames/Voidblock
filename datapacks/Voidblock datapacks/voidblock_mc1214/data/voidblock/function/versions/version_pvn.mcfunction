...
scoreboard objectives add PVN_0_mc1219d dummy
scoreboard players add @a PVN_0_mc1219d 1
execute as @a[scores={Voidblock_id=10}] run scoreboard objectives remove PVN_0_mc1219d
execute as @a[scores={Voidblock_import=20}] run scoreboard objectives remove PVN_0_mc1219d
...
#execute as @a[scores={PVN_0_mc1219d=6}] run tellraw @s ["",{"color":"red","translate":"skyblock_classic_edition.version_update.development_mc_version"}]
