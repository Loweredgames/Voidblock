...
scoreboard objectives add PVN_0_mc1219b dummy
scoreboard players add @a PVN_0_mc1219b 1
execute as @a[scores={Voidblock_id=10}] run scoreboard objectives remove PVN_0_mc1219b
execute as @a[scores={Voidblock_import=20}] run scoreboard objectives remove PVN_0_mc1219b
...
#execute as @a[scores={PVN_0_mc1219b=6}] run tellraw @s ["",{"color":"red","translate":"skyblock_classic_edition.version_update.development_mc_version"}]


##PVN VERSION PROTOCOL LOOP (NON TOCCARE MAI)
execute as @a[scores={PVN_0_mc1219b=900000000..}] run scoreboard players set @a PVN_0_mc1219b 0