...
execute as @a[scores={Voidblock_pid_mc121=1000..}] run scoreboard objectives remove PID_legacy_v1
execute as @a[scores={Voidblock_pid_mc121=1000..}] run scoreboard objectives remove PID_legacy_v2
execute as @a[scores={Voidblock_pid_mc121=1000..}] run scoreboard objectives remove PID_legacy_v3


##SETUP VERSION Voidblock_ID (CAMBIARE LA SCORE IN "Voidblock_id". VEDERE LA SCORE PID_X PER RIFERIMENTO)
execute as @a[scores={Voidblock_id=30}] run scoreboard players set @a Voidblock_pid_mc121 -100
