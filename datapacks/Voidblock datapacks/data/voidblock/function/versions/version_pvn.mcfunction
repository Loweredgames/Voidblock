...
scoreboard objectives add 1.21.4_PVN_0b dummy
scoreboard players add @a 1.21.4_PVN_0b 1
execute as @a[scores={Voidblock_id=10}] run scoreboard objectives remove 1.21.4_PVN_0b
execute as @a[scores={Voidblock_import=20}] run scoreboard objectives remove 1.21.4_PVN_0b
