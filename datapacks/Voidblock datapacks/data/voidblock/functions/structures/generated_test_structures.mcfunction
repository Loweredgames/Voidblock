...
execute as @a[scores={Voidblock_test_structures=1426}] run title @a title {"text":"Structures:","italic":true}
execute as @a[scores={Voidblock_test_structures=1426}] run title @a subtitle {"text":"They were generated...","italic":true}
